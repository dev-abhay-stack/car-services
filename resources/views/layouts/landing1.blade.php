...
<nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
    <div class="container">
        <a class="navbar-brand bg-transparent" href="#">
            <img src="{{ asset(Storage::url('logo/logo-light.png'))}}" alt="logo" class="navbar-logo"/>
        </a>
        <button
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <h2
                    ...
                    data-wow-delay="0.4s"
                >
                   {{ __('Maintenance Management System') }}
                </h2>
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="https://demo.rajodiya.com/cmmsgo-saas" class="btn btn-light me-2"
                    ><i class="far fa-eye me-2"></i>{{ __('Live Demo') }}</a
                    >
                    <a href="https://codecanyon.net/item/cmmsgo-saas-maintenance-management-system/36662537" class="btn btn-outline-light" target="_blank"
...
<section id="dashboard" class="theme-alt-bg dashboard-block">
    <div class="container">
        ...
        <img
            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-1.png'))}}"
            alt=""
        ...
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                    {{ __('Maintenance Management')}}<br> {{ __('System') }}
                </h2>
                <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="https://codecanyon.net/item/cmmsgo-saas-maintenance-management-system/36662537" class="btn btn-primary" target="_blank"
    ...
    <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="https://codecanyon.net/item/cmmsgo-saas-maintenance-management-system/36662537s" class="btn btn-primary" target="_blank"
                    ><i class="fas fa-shopping-cart me-2"></i>Buy now</a
                    >
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                <div class="row feature-img-row m-auto">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-2.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.4s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-14.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.6s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-10.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.8s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-12.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.3s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-13.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.5s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-6.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.7s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/cmmsgo-saas-pic-7.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.9s"
                            alt="Admin"
                        />
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <img src="{{asset(Storage::url('logo/logo-dark.png'))}}" alt="logo" class="navbar-logo" />
            </div>
