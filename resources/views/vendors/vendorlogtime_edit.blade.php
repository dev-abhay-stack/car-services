    ...
    {{Form::model($vendorlogtime,array('route' => array('vendorlogtime.update', $vendorlogtime->id), 'method' => 'PUT')) }}
    <input type="hidden" name="vendor_id" value="{{$vendorlogtime->vendor_id}}">
    <div class="row">
